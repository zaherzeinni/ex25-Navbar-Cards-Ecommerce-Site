...
_hover={{transform: 'translatey(-2%)'  }}
 transition="0.5s all"> */}
  ...
  <Card 
    ...
    cover={<img alt="imge" src={props.IMG1} style={{height:'280px',width:'500px',position:"absolute",borderRadius:"0px 0px 0px 0px"}}  />}
  >

    <Container  position="relative" top={220} w={300} columns={[1,2,3]} >
    <Box position="relative" textAlign={"center"} fontSize="16px" fontWeight="bold" bg={'white'} borderRadius="5px 5px 0px 0px" >{props.Title}</Box>
